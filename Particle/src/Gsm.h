...
private:
   ...
   // String cloudPumpId;
    ...
    int max_opperations_per_day = (gsmParameters.maxTotalOperations/NUM_DAYS_IN_MONTH)/gsmParameters.totalParticles;
    int max_data_bytes_sent = (MAX_BYTES_PER_DATA_OPERATION - gsmParameters.maxHeaderSize);
    int total_message_cap = (max_data_bytes_sent / gsmParameters.maxMessageSize);
    int time_btwn_messages = CEILING((TOTAL_SECONDS_DAY / max_opperations_per_day), total_message_cap);
